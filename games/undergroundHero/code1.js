...
gdjs.BattleCode.GDPlayerObjects3= [];
gdjs.BattleCode.GDPlayerObjects4= [];
gdjs.BattleCode.GDNPCObjects1= [];
gdjs.BattleCode.GDNPCObjects2= [];
gdjs.BattleCode.GDNPCObjects3= [];
gdjs.BattleCode.GDNPCObjects4= [];
gdjs.BattleCode.GDNativeObjects1= [];
gdjs.BattleCode.GDNativeObjects2= [];
gdjs.BattleCode.GDNativeObjects3= [];
gdjs.BattleCode.GDNativeObjects4= [];
gdjs.BattleCode.GDTracyObjects1= [];
gdjs.BattleCode.GDTracyObjects2= [];
gdjs.BattleCode.GDTracyObjects3= [];
gdjs.BattleCode.GDTracyObjects4= [];
gdjs.BattleCode.GDTwiggyObjects1= [];
gdjs.BattleCode.GDTwiggyObjects2= [];
gdjs.BattleCode.GDTwiggyObjects3= [];
gdjs.BattleCode.GDTwiggyObjects4= [];


gdjs.BattleCode.asyncCallback23883644 = function (runtimeScene, asyncObjectsList) {
...
gdjs.BattleCode.idToCallbackMap.set(23883644, gdjs.BattleCode.asyncCallback23883644);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.BattleCode.asyncCallback23883644(runtimeScene, asyncObjectsList)), 23883644, asyncObjectsList);
}
}
...
};gdjs.BattleCode.asyncCallback23894604 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.BattleCode.localVariables);
...
gdjs.BattleCode.idToCallbackMap.set(23894604, gdjs.BattleCode.asyncCallback23894604);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.BattleCode.asyncCallback23894604(runtimeScene, asyncObjectsList)), 23894604, asyncObjectsList);
}
}
...
};gdjs.BattleCode.asyncCallback23893484 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.BattleCode.localVariables);
...
{for(var i = 0, len = gdjs.BattleCode.GDEnemyObjects3.length ;i < len;++i) {
    gdjs.BattleCode.GDEnemyObjects3[i].getBehavior("Health").Hit(gdjs.randomInRange(10, 15), true, true, null);
}
}
...
gdjs.BattleCode.idToCallbackMap.set(23893484, gdjs.BattleCode.asyncCallback23893484);
...
const asyncObjectsList = gdjs.LongLivedObjectsList.from(parentAsyncObjectsList);
asyncObjectsList.backupLocalVariablesContainers(gdjs.BattleCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.BattleCode.asyncCallback23893484(runtimeScene, asyncObjectsList)), 23893484, asyncObjectsList);
}
}
...
};gdjs.BattleCode.asyncCallback23893084 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.BattleCode.localVariables);
...
gdjs.BattleCode.idToCallbackMap.set(23893084, gdjs.BattleCode.asyncCallback23893084);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.BattleCode.asyncCallback23893084(runtimeScene, asyncObjectsList)), 23893084, asyncObjectsList);
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23892684);
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.BattleCode.GDPlayerObjects1);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23889620);
}
}
if (isConditionTrue_0) {
...
};gdjs.BattleCode.asyncCallback23897468 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.BattleCode.localVariables);
{runtimeScene.getScene().getVariables().getFromIndex(0).setString("PlayEnemyAttack");
}
gdjs.BattleCode.localVariables.length = 0;
}
gdjs.BattleCode.idToCallbackMap.set(23897468, gdjs.BattleCode.asyncCallback23897468);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.BattleCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.BattleCode.asyncCallback23897468(runtimeScene, asyncObjectsList)), 23897468, asyncObjectsList);
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23897308);
}
if (isConditionTrue_0) {
...
};gdjs.BattleCode.asyncCallback23901236 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.BattleCode.localVariables);
...
gdjs.BattleCode.idToCallbackMap.set(23901236, gdjs.BattleCode.asyncCallback23901236);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.BattleCode.asyncCallback23901236(runtimeScene, asyncObjectsList)), 23901236, asyncObjectsList);
}
}
...
};gdjs.BattleCode.asyncCallback23898580 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.BattleCode.localVariables);
gdjs.copyArray(runtimeScene.getObjects("Dialogue"), gdjs.BattleCode.GDDialogueObjects3);
...
{for(var i = 0, len = gdjs.BattleCode.GDPlayerObjects3.length ;i < len;++i) {
    gdjs.BattleCode.GDPlayerObjects3[i].getBehavior("Health").Hit(gdjs.randomInRange(10, 15), true, true, null);
}
}
{for(var i = 0, len = gdjs.BattleCode.GDDialogueObjects3.length ;i < len;++i) {
...
gdjs.BattleCode.idToCallbackMap.set(23898580, gdjs.BattleCode.asyncCallback23898580);
...
const asyncObjectsList = gdjs.LongLivedObjectsList.from(parentAsyncObjectsList);
asyncObjectsList.backupLocalVariablesContainers(gdjs.BattleCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.BattleCode.asyncCallback23898580(runtimeScene, asyncObjectsList)), 23898580, asyncObjectsList);
}
}
...
};gdjs.BattleCode.asyncCallback23898508 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.BattleCode.localVariables);
...
gdjs.BattleCode.idToCallbackMap.set(23898508, gdjs.BattleCode.asyncCallback23898508);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.BattleCode.asyncCallback23898508(runtimeScene, asyncObjectsList)), 23898508, asyncObjectsList);
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23898692);
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Enemy"), gdjs.BattleCode.GDEnemyObjects1);
...
gdjs.BattleCode.GDPlayerObjects3.length = 0;
gdjs.BattleCode.GDPlayerObjects4.length = 0;
gdjs.BattleCode.GDNPCObjects1.length = 0;
gdjs.BattleCode.GDNPCObjects2.length = 0;
gdjs.BattleCode.GDNPCObjects3.length = 0;
gdjs.BattleCode.GDNPCObjects4.length = 0;
gdjs.BattleCode.GDNativeObjects1.length = 0;
gdjs.BattleCode.GDNativeObjects2.length = 0;
gdjs.BattleCode.GDNativeObjects3.length = 0;
gdjs.BattleCode.GDNativeObjects4.length = 0;
gdjs.BattleCode.GDTracyObjects1.length = 0;
gdjs.BattleCode.GDTracyObjects2.length = 0;
gdjs.BattleCode.GDTracyObjects3.length = 0;
gdjs.BattleCode.GDTracyObjects4.length = 0;
gdjs.BattleCode.GDTwiggyObjects1.length = 0;
gdjs.BattleCode.GDTwiggyObjects2.length = 0;
gdjs.BattleCode.GDTwiggyObjects3.length = 0;
gdjs.BattleCode.GDTwiggyObjects4.length = 0;
